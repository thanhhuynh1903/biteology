    ...
    >
      <Row gutter={[32, 32]} justify="center">
        ...
        <Col xs={24} sm={12} md={5}>
          ...
          <Space direction="vertical">
            <Link style={{ color: "#333333" }} href="/medical">
              Health Tracking
            </Link>
            <Link style={{ color: "#333333" }} href="/">
              Nutritional Counseling
            </Link>
            <Link style={{ color: "#333333" }} href="/food">
              Library control
            </Link>
          </Space>
        </Col>
        ...
        <Col xs={24} sm={12} md={5}>
          ...
          <Space direction="vertical">
            ...
            <Link style={{ color: "#333333" }} href="/payment">
              Premium Package
            </Link>
        ...
        <Col xs={24} sm={12} md={4}>
          ...
          <Space size="large">
            ...
            <XOutlined
              ...
              onClick={() => window.open("https://x.com/BiteologyHealth")}
            />
            <InstagramOutlined
              style={{ fontSize: 24, color: "#333333" }}
              onClick={() =>
                window.open("https://www.instagram.com/biteology_health")
              }
            />
            <TelegramIcon
              onClick={() => window.open("https://t.me/biteology_health")}
              style={{ cursor: "pointer" }}
            />
            <BookOutlined
              style={{ fontSize: 24, color: "#333333" }}
              onClick={() =>
                window.open("https://biteologys-team.gitbook.io/biteology-docs")
              }
            />
          </Space>
        </Col>
